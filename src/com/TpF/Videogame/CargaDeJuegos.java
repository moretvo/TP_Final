...
public class CargaDeJuegos {
    ...
    protected Juego UntilDawn = new Juego ("Until Dawn", Sony, "2015-08-26", Genero.AVENTURA, ESRB.M, Consola.PLAYSTATION_4);
...
/*    HashMap<Integer, Juego> hashJuego = new HashMap<>();
		hashJuego.put(DevilMayCry3.hashCode(), DevilMayCry3);
		hashJuego.put(KingdomHearts3.hashCode(), KingdomHearts3);
		hashJuego.put(UntilDawn.hashCode(), UntilDawn);
		hashJuego.put(ResidentEvil7.hashCode(), ResidentEvil7);
*/
